    ...
    <AboutPageDiv>
      <Container title={"Bingo Tournament 2022"} width={"70%"}>
        <AboutContent>
          ...
          <h3>General info</h3>
          <List>
            <ListItem>The tournament will start on …</ListItem>
            <ListItem>
              This is a regular{" "}
            ...
            <ListItem>
              ...
              account with at least one race in the OoT bingo category is required to join the
              tournament. You may sign up before you completed one race, but should finish one
          ...
          <List>
            <ListItem>
              ...
              and announced when about to start.
            </ListItem>
            <ListItem>
          ...
          <List>
            <ListItem>
              ...
              race by pressing the 'Pick time' button. Only one match entrant has to do so. Please
              only schedule after you agreed on a time with your opponent.
            </ListItem>
            <ListItem>
              You can record the results of the match to the website after the Racetime race has
              been <strong>recorded</strong>. Copy the url and click the ''.
              <InternalLink to="/profile/matches">profile page</InternalLink>. You can schedule your
              race by pressing the 'Pick time' button. Only one match entrant has to do so. Please
              only schedule after you agreed on a time with your opponent.
            </ListItem>
          ...
          <List>
            ...
            <ListItem>Each round starts on … and lasts exactly one week.</ListItem>
            <ListItem>
            ...
            <ListItem>
              A win is awarded <strong>3</strong> points. In the unlikely case of a draw, both
              players are awarded <strong>1</strong> point.
            </ListItem>
            <ListItem>
              A forfeit is counted as a <strong>4:00:00</strong> time.
            </ListItem>
            <ListItem>
